...
CREATE TABLE `csv_data` (
  ...
  `csv_filename` varchar(225) DEFAULT NULL,
  `csv_header` varchar(225) DEFAULT NULL,
  `csv_data` longtext,
...
CREATE TABLE `info` (
  ...
  `datanasc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `migrations` VALUES (1,'2020_07_05_015405_create_gmaps_geocache_table',1);
...
-- Dump completed on 2020-07-11 23:03:29
