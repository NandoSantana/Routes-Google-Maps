...
class GMaps
{
    ...
    public $geoCacheTableName = 'info';   //Geo cache database table name
    ...
    public $directions = true;                    // Whether or not the map will be used to show directions
    ...
    public $directionsAvoidTolls = true;                    // Whether or not directions should avoid tolls
    ...
    public $places = true;                    // Whether or not the map will be used to show places
    ...
    public function add_marker($params = array())
    {
        ...
        $marker['flat'] = true;                                // If set to TRUE will not display a shadow beneath the icon
    ...
    public function create_map()
    {
        ...
        if ($this->directions && $this->directionsStart != "" && $this->directionsEnd != "") {
            if ($this->directionsStart == "auto" && $this->directionsEnd == "auto") {
                ...
                $ArrayDirectionStart = $this->directionsStart;
                // The start and end point are at pre-defined locations
                // for ($i=0; $i < count($this->directionsStart); $i++) { 
                    $this->output_js_contents .= '
        ...
        if ($this->directions) {
            ...
            if (count($this->paths)) 
            {
                ...
                foreach ($this->paths as $waypoint) {
